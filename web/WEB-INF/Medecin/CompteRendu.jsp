...
<head>
    ...
    <title>Consulter Comptes rendus</title>
</head>
<body>
<header>
    <div id="div1_h" >
...
<h2>Consulter les comptes rendus</h2>
...
<div id="div_22">
    <c:forEach var="list" items="${list}">
        ...
        <ol>
            <li>
                Compte rendu : <c:out value="${list.id}"/>
                <span id="span4_f"> Contenue :<c:out value="${list.detaille}"/> </span>
            </li>
        </ol>
    </c:forEach>
