...
<ul style =" list-style-type: none; margin: 0;width: 65%; text-align:center;margin-left:200px ;margin-bottom: 0">
    <li style = " border: 0px solid #ddd;
        ...
        <button style=" background-color: transparent;
                     ...
                     height: 35px;
                     margin-top: 25px;
                     width: 120px;"><a href="/SIH_war_exploded/DemandesActes"> Gérer</a></button>
    ...
    <li style = " border: 0px solid #ddd;
        ...
        <button style=" background-color: transparent;
                     ...
                     height: 35px;
                     margin-top: 25px;
                     width: 120px;"><a href="/SIH_war_exploded/ResultatsActes">Consulter</a></button>
    </li>
</ul>
<footer>
