...
<section id="sec">
    ...
    <div style="width: 500px;position: relative;left: 200px;">
        <h1 style="position: relative;top: -40px;font-size: 30px;">Ajouter un service</h1>
        <form method="post" action="AjouterService">
            <div>
                <input type="text" placeholder="Nom Service" name="nom" class="input1" required >
            </div>
            <br>
            <div>
                <input type="text" placeholder="Etage" name="etage" class="input1" required >
            </div>
            <br>
            <div>
                <input type="text" placeholder="Aile" name="aile" class="input1" required>
            </div>
            <br>
            <div>
                <input type="text" placeholder="Chef Service" name="idchef" class="input1" required=>
            </div>
            <div style="width: 200px;position: relative;left: 300px;top:-50px;">
                <button class="but_tab" type="submit">Valider</button>
            </div>
