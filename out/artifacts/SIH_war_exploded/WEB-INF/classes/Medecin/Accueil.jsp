...
<table style="width:55% ;
    ...
    <tr>
        ...
        <td><c:out value="${ utilisateur.grade} " /></td>
        <td><c:out value="${ utilisateur.specialite} " /></td>
    </tr>
...
<ul style ="  list-style-type: none;
    ...
    <li style = " border: 0px solid #ddd;
        ...
        <button style=" background-color: transparent;
                     ...
                     font-size: 18px;
                     height: 35px;
                     width: 120px;" ><a href="/SIH_war_exploded/Consultations">Consulter</a></button>
    ...
    <li style = " border: 0px solid #ddd;
        ...
        <button style="margin-top: 25px ;
                      ...
                      "><a href="/SIH_war_exploded/AjouterConsultation">Ajouter</a></button>
