...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/ajouter prescription.css">
    <title></title>
</head>
<body>
...
<form >
    <h2>Ajouter une Préscription</h2>

    <h3> Choisissez le(s) type(s) à préscrire</h3>

    <div class="container">
        <ul class="ks-cboxtags">


            <li><input type="radio" id="checkboxThree" name="typePrescription" value="medicament" checked><label for="checkboxThree">Medicament</label></li>
            <li><input type="radio" id="checkboxTwo" name="typePrescription" value="perfusion" checked><label for="checkboxTwo">Perfusion</label></li>
            <li><input type="radio" id="checkboxOne" name="typePrescription" value="produitssanguins"><label for="checkboxOne">Produit sanguin</label></li>

        </ul>
    </div>


    <textarea name="detaille" placeholder="Saisissez présecription ici! " ></textarea>
