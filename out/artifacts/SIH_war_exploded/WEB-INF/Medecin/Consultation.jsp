...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/div2.css">
    ...
    <ul id="plans">
        ...
        <li class="plan1">
            <ul class="planContainer1">
                ...
                <li> <form method="get" action="CompteRendu">
                    <input type="hidden" name="compterendu" value="${consultation.id}">
                    <button id="abt"> consulter </button></form></li>
                <li><br></li>
            </ul>
        </li>
        ...
        <li class="plan2">
            <ul class="planContainer2">
                ...
                <li> <form method="get" action="ActeComplementaire">
                    <input type="hidden" name="actecomplementaire" value="${consultation.id}">
                    <button id="abt"> consulter </button></form></li>
                <li></br></li>
            </ul>
        </li>
        ...
        <li class="plan3">
            <ul class="planContainer3">
                <li class="title"><h2>Prescription</h2></li>
                <li class="price"><p></p></li>
                <li>
                    <ul class="options">
                        <li><br/></li>
                ...
                <li>
                    <form method="get" action="Prescription">
                        <input type="hidden" name="prescription" value="${consultation.id}">
                        <button id="abt"> consulter </button></form></li>
                <li><br></li>
            </ul>
        </li>
        ...
        <li class="plan4">
            <ul class="planContainer4">
                ...
                <li> <form method="get" action="PlanSoin">
                    <input type="hidden" name="plansoin" value="${consultation.id}">
                    <button id="abt"> consulter </button></form></li>
                <li></br></li>
            </ul>
        </li>
