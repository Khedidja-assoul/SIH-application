...
<head>
    ...
    <title>Consulter les préscriptions</title>
</head>
<body>
<header>
    <div id="div1_h" >
...
<h2>Consulter les préscriptions</h2>
...
<c:forEach var="list" items="${list}">
    ...
    <ol>
    <li> Type Prescription :
    <c:forEach var="soin" items="${list.typePrescription}">
        <span id="span4_f">Contenue :<c:out value="${list.deatille}"/></span>
        </li>
        </ol>
    </c:forEach>
</c:forEach>
