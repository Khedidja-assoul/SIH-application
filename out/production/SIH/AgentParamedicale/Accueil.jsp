...
<head>
    ...
    <title>Acceuil Agent Paramedical</title>
    <style>
        th, td {
            padding: 10px;
            text-align:left;
...
<img style="height: 150px;
     ...
     float: left;
     margin-left: 210px
     "src ="${pageContext.request.contextPath}/img/11.png"/>
<h1 style =";font-size:30px;
    text-decoration: none;
    margin-left:300px;
    margin-top: 40px;
    color: #75cba8;
    ">AGENT PARAMEDICAL  </h1>
...
<ul style =" list-style-type: none; margin: 0;width: 65%; text-align:center;margin-left:200px ;margin-bottom: 0">
    <li style = " border: 0px solid #ddd;
        ...
        <button style=" background-color: transparent;
                     ...
                     height: 35px;
                     margin-top: 25px;
                     width: 200px;"><a href="/SIH_war_exploded/GestionPatient">Gestion Patient</a></button>
    ...
    <li style = " border: 0px solid #ddd;
        ...
        <button style=" background-color: transparent;
                     ...
                     height: 35px;
                     margin-top: 25px;
                     width: 200px;"><a href="/SIH_war_exploded/GestionRdvs">Gestion Rendez-vous</a></button>
    </li>
